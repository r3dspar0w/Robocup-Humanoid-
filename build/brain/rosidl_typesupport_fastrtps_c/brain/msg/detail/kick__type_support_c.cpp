...
#include "brain/msg/detail/kick__rosidl_typesupport_fastrtps_c.h"
...
using _Kick__ros_msg_type = brain__msg__Kick;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Kick__ros_msg_type * ros_message = static_cast<const _Kick__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: robot_theta_to_field
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Kick__ros_msg_type * ros_message = static_cast<_Kick__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_brain__msg__Kick(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Kick__ros_msg_type * ros_message = static_cast<const _Kick__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Kick__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_brain__msg__Kick(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_brain
size_t max_serialized_size_brain__msg__Kick(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = brain__msg__Kick;
    is_plain =
      (
...
static size_t _Kick__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_brain__msg__Kick(
...
static message_type_support_callbacks_t __callbacks_Kick = {
  "brain::msg",
  "Kick",
...
static rosidl_message_type_support_t _Kick__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, brain, msg, Kick)() {
  return &_Kick__type_support;
}
