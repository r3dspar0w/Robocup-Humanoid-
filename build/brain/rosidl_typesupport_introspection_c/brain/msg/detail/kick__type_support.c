...
static rosidl_typesupport_introspection_c__MessageMember brain__msg__Kick__rosidl_typesupport_introspection_c__Kick_message_member_array[8] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(brain__msg__Kick, power),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
