...
bool brain__msg__kick__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("brain.msg._kick.Kick", full_classname_dest, 20) == 0);
  }
  brain__msg__Kick * ros_message = _ros_message;
  {  // header
  ...
  {  // robot_theta_to_field
    PyObject * field = PyObject_GetAttrString(_pymsg, "robot_theta_to_field");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->robot_theta_to_field = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // power
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * brain__msg__kick__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Kick */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("brain.msg._kick");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Kick");
  ...
  brain__msg__Kick * ros_message = (brain__msg__Kick *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // robot_theta_to_field
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->robot_theta_to_field);
    {
      int rc = PyObject_SetAttrString(_pymessage, "robot_theta_to_field", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
