...
void RobotClient::init(string robot_name)
{
    ...
    brain->log->log(
        ...
        "routing all velocity commands to motion_control_node custom policy");
}
...
{
    std::cout << "RobotClient::robocupWalk returning to custom policy mode" << std::endl;
