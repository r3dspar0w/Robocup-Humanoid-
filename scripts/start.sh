...
MOTION_CONTROL_AUTO_CHANGE_MODE="${MOTION_CONTROL_AUTO_CHANGE_MODE:-false}"
...
log_event "[START] motion_control_node network_interface='$MOTION_CONTROL_NETWORK_INTERFACE' auto_change_mode='$MOTION_CONTROL_AUTO_CHANGE_MODE' start_enabled='true'"
